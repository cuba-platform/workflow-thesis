...
public class AttachmentActionTools {
     ...
     * @param window           Window
     */
    public void createLoadAction(Table attachmentsTable, Frame window) {
        final Table attachments = attachmentsTable;
     ...
     */
    public Action createMultiUploadAction(Table attachmentsTable, Frame window, AttachmentCreator creator) {
     ...
     * @return Multifile upload action
     */
    public Action createMultiUploadAction(Table attachmentsTable, Frame window, final AttachmentCreator creator,

...
package com.haulmont.workflow.core.app.prettytime;
...
public class CubaPrettyTimeParser {
    ...
    @Inject
    protected PrettyTimeConfig prettyTimeConfig;
    ...
    @PostConstruct
    public void init() {
        StrTokenizer tokenizer = new StrTokenizer(prettyTimeConfig.getPrettyTimeProperties());
        try {

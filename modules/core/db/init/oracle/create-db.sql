create table WF_ASSIGNMENT (
    ...
    MASTER_ASSIGNMENT_ID varchar2(32 char),
    NAME varchar2(255 char),
    DESCRIPTION varchar2(1000 char),
    JBPM_PROCESS_ID varchar2(255 char),
    DUE_DATE timestamp,
    FINISHED timestamp,
    FINISHED_BY varchar2(32 char),
    OUTCOME varchar2(255 char),
    ASSIGNMENT_COMMENT clob,
    ITERATION integer,
    SUBPROC_CARD_ID varchar2(32 char),
    FAMILY_ASSIGNMENT_ID varchar2(32 char),
...
create table WF_ATTACHMENT (
    ...
    ATTACHMENT_COMMENT varchar2(1000 char),
    SIGNATURES clob,
    CARD_ID varchar2(32 char),
    ASSIGNMENT_ID varchar2(32 char),
    VERSION_OF_ID varchar2(32 char),
    RECOGNIZED_FILE_ID varchar2(32 char),
    VERSION_NUM integer,
...
create table WF_ATTACHMENTTYPE (
    ...
    VERSION integer,
    NAME varchar2(500 char),
    ATTACHMENTTYPE_COMMENT varchar2(1000 char),
    ISDEFAULT char(1),
...
create table WF_CALENDAR (
    ...
    CALENDAR_COMMENT varchar2(500 char),
    primary key(ID)
)^
...
create table WF_CARD (
    ...
    FAMILY_CARD_ID varchar2(32 char),
    FAMILY_JBPM_PROCESS_ID varchar2(255 char),
...
create table WF_CARD_COMMENT_USER (
    CARD_COMMENT_ID varchar2(32 char) not null,
...
create table WF_CARD_RELATION (
    ...
    DELETED_BY varchar2(50 char),
    CARD_ID varchar2(32 char),
    RELATED_CARD_ID varchar2(32 char),
    primary key(ID)
)^
...
create table WF_DESIGN_FILE (
    ...
    CREATE_TS timestamp,
    CREATED_BY varchar2(50 char),
    DESIGN_ID varchar2(32 char),
    NAME varchar2(100 char),
    DESIGN_FILE_TYPE varchar2(20 char),
    CONTENT clob,
    BINARY_CONTENT blob,
    primary key(ID)
)^
...
create table WF_PROC (
    ...
    DELETED_BY varchar2(50 char),
    NAME varchar2(255 char),
    JBPM_PROCESS_KEY varchar2(255 char),
    CODE varchar2(255 char),
    MESSAGES_PACK varchar2(200 char),
    CARD_TYPES varchar2(500 char),
    STATES varchar2(1500 char),
    PERMISSIONS_ENABLED char(1),
    DESIGN_ID varchar2(32 char),
    AVAILABLE_ROLE_ID varchar2(32 char),
...
create table WF_PROC_ROLE (
    ...
    SORT_ORDER integer,
    ORDER_FILLING_TYPE varchar2(1 char),
    primary key(ID)
)^
...
create table WF_TIMER (
    ...
    JBPM_EXECUTION_ID varchar2(255 char),
    ACTIVITY varchar2(255 char),
    ACTION_CLASS varchar2(200 char),
    ACTION_PARAMS varchar2(2000 char),
    FACTORY_CLASS clob,
    primary key(ID)
)^
...
create table WF_USER_GROUP_USER (
    USER_GROUP_ID varchar2(32 char) not null,
    USER_ID varchar2(32 char) not null,
